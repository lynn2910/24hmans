...
let prestataires = [{
    ...
    "id": "e14a5d1a-7f67-482e-ac6f-72133cb8a802",
    "name": "Ferrari",
    icon: "prestataires_icons/ferrari.jpg",
    "password": "$2a$10$4JF2Hpizs3j5jn7MqifZFOYTHgCU4xePCgCSyd7nnxlQGRWK40fvm",
    "description": "",
    "links": [],
    "accentColor": "#cc232a",
    "banner": null
...
let boutiques = [
    // Porsche
    {
        ...
        enabled: true,
        categories: [
            {category_id: "9af710a9-9c13-43d7-b710-a99c1323d77d", category_label: "Écusson"},
            {category_id: "be2cff03-7d12-4369-acff-037d12a36993", category_label: "Porte-clé"},
            {category_id: "0ce99bfb-adaa-4c9c-a423-8ea2c700c3c5", category_label: "Voitures"}
