<template>
	<AdminDashboardTemplate current-page="prestataires">
		<div class="space-y-6 h-full overflow-auto flex flex-row gap-6">
			<div class="bg-blue-50/10 p-6 rounded-xl border border-gray-700 w-full">
			...
			<div class="w-2/5 bg-blue-50/10 p-6 rounded-xl border border-gray-700 mt-0" style="margin-top: 0 !important;">
