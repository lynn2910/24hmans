<template>
	<nav class="w-full fixed top-2 left-0 flex flex-row space-between z-50">
		...
		<!--    </div>-->
		<div
				class="w-[95%] bg-dark m-auto rounded-full text-white flex flex-row font-semibold space-x-8 px-4 py-1 items-center content-center shadow-2xl shadow-red-700">
			...
			<div class="flex flex-row items-center justify-center mr-auto w-3/4 gap-8">
				...
				<router-link to="/ecurie/porsche"><p>Ecurie Porsche</p></router-link>
